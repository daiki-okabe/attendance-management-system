...
@NamedQueries({
    ...
    @NamedQuery(
            ...
            query = "SELECT d FROM Department AS d WHERE d.del_flg=0 AND d.department_id=:dept_id ORDER BY d.department_id ASC"
    )
})
...
public class Department {
    ...
    @Column(name = "DIVIDION_ID", length = 3, nullable = false)
