        ...
        <div id="atendance_parts">
            <table id="solid_border">
                   ...
                   <tr>
                            ...
                            <table>
                                       ...
                                       <tr>
                                               <td>
                                                   <table>
                                                         <tr>
                                                             <td id="main_menu_time_stump" align="left">
                                                                        <label >${start_date}</label>
                                                             </td>
                                                             <td  id="main_menu_time_stump" align="right">
                    ...
                    <tr>
                        <th >
                            <a href="<c:url value='/work_log_edit'/>" id="mainmenu_edit_link">勤怠情報を編集する</a>
                        </th>
                    </tr>
            </table>
        </div>
